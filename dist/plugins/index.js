...
var METHOD_COLORS = {
  GET: import_chalk.default.green,
  POST: import_chalk.default.blue,
  PUT: import_chalk.default.yellow,
  DELETE: import_chalk.default.red,
  PATCH: import_chalk.default.magenta,
  OPTIONS: import_chalk.default.cyan
};
var TIME_COLORS = {
  slow: import_chalk.default.red,
  medium: import_chalk.default.yellow,
  fast: import_chalk.default.green
};
var logger = () => async (ctx, next) => {
  const t = performance.now();
  const result = await next();
  const time = Math.round(performance.now() - t);
  const colorFn = METHOD_COLORS[ctx.method] || import_chalk.default.white;
